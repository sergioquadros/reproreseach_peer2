...
no <-c("/","-","  ","agricultural","early","ligth","late","very","abnormally","abnormal","unseasonal","extreme","excessively","excessive","unseasonable","heavy","hard","strong","unseasonably","record","gusty","minor","moderate","monthly","unusually","unusual","dense","cstl flood erosion","tstm","strm","wnd","mud slide","coastalstorm","hurricane edouard","hurricane typhoon","typhoon","hurricane hurricane","wildfire","brush fire","coastal flood erosion","coastalflood","wintery mix","wintry mix","winter weather mix","fld","flooding","floodg","flood flood","prolonged","prolong","damaging","\\(g40\\)","\\(g35\\)","\\(g45\\)","\\(0.75\\)","45","\\(41\\)","g$","s$","\\(","thunderstorm wind and lightnin","erosion/cstl flood")
yes <- c(" "," "," ","","","","","","","","","","","","","","","","","","","","","","","","","coastal flood","thunderstorm","stream","wind","mudslide","coastal storm","hurricane","hurricane","hurricane","hurricane","wild forest fire","wild forest fire","coastal flood","coastal flood","winter weather","winter weather","winter weather","flood","flood","flood","flood","","","","","","","","","","","","","thunderstorm wind","coastal flood")
prolonged rain        rain
215	prolong warmth	 warmth
...
# length(no)=length(yes)=56
# problems with "[:digit:]" and "[:punct:]"

data1 %<>% merge(new_ev,by.x="evtype",by.y="old")

data1$new1 %<>% as.factor
evtype_number <- length(unique(data1$new1))
```
